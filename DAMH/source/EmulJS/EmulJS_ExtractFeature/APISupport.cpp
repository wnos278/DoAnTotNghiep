...
void scElementAppendChild(CVar*pVLocalStack, void *pUserData)
{
	...
	// Kiem tra virus ..........................................................
	//nTypeVirus = programJs->CheckVirus(pVNewElement);
	//if (nTypeVirus == VR_TYPE_INSERT_TAG_HIDDEN) // nếu loại là thế này và trong hàm element.appendcChild thì trả về virus kiểu này
	//{
	//	pRE = new CRuntimeException(VR_NAME_APPEND_CHILD, EXCEPTIONID_FOUND_VIRUS, false);
	//	pRE->SetVirusName(VR_NAME_APPEND_CHILD);
	//	throw pRE;
	//}
	//// .........................................................................
	//else if (nTypeVirus == VR_TYPE_INSERT_STYLE_HIDDEN)
	//{
	//	pRE = new CRuntimeException(VR_NAME_HIDDEN_LINK, EXCEPTIONID_FOUND_VIRUS, false);
	//	pRE->SetVirusName(VR_NAME_HIDDEN_LINK);
	//	throw pRE;
	//}
	// .........................................................................
...
void scSetTimeOut(CVar*pVLocalStack, void *pUserData){
	CProgramJs *pProgramJs = (CProgramJs*)pUserData;
	CVar* pVThisObject = pVLocalStack->GetParameter("time");
    CRuntimeException* pREHadVirus = NULL;
	string sLinkCheckRedirect_2;

	/*if (pVThisObject && pVThisObject->IsString())
	{
		sLinkCheckRedirect_2 = pVThisObject->GetString();
		if (sLinkCheckRedirect_2.find("location") != string::npos)
		{
			pREHadVirus = new CRuntimeException(VR_NAME_REDIRECT, EXCEPTIONID_FOUND_VIRUS, false);
			pREHadVirus->SetVirusName(VR_NAME_REDIRECT);
			throw pREHadVirus;
...
void scDoublesaveToFile(CVar *pVLocalStack, void* pUserData)
{
	...
	CProgramJs *programJs = (CProgramJs*)pUserData;
	CRuntimeException* pREHadVirus = NULL;
	string sHtmlCode = "DownloaderJS";
	/*if ((g_sstrDetectDownloader->bCreateObject == true)
		&& (g_sstrDetectDownloader->bOpen == true))
	{

		if (g_sstrDetectDownloader->bString == true || programJs->CheckVirusDownloader(sHtmlCode))
		{
			pREHadVirus = new CRuntimeException(VR_NAME_DOWNLOADER, EXCEPTIONID_FOUND_VIRUS, false);
			pREHadVirus->SetVirusName(VR_NAME_DOWNLOADER);
			throw pREHadVirus;
...
// 	CProgramJs *programJs = (CProgramJs*)pUserData;
// 	CRuntimeException* pREHadVirus = NULL;
// 	string sHtmlCode = "Khong gia tri";
// 	if ((g_sstrDetectDownloader->bCreateObject = true)
// 		&& (g_sstrDetectDownloader->bOpen = true))
// 	{
// 
// 		if (programJs->CheckVirusDownloader(sHtmlCode))
// 		{
// 			pREHadVirus = new CRuntimeException(VR_NAME_DOWNLOADER, EXCEPTIONID_FOUND_VIRUS, false);
// 			pREHadVirus->SetVirusName(VR_NAME_DOWNLOADER);
// 			throw pREHadVirus;
// 		}
// 	}
// 	scReturnString("NDC - Today is a good day");
// }

// void scDoubleclose(CVar *pVLocalStack, void *pUserData){
// 	scReturnString("NDC - Today is a good day");
// }
// 
// 
// void scDoubleLoadFromFile(CVar *pVLocalStack, void*){
// 	scReturnString("NDC - Today is a good day");
// }
...
{
	/*g_sstrDetectDownloader->bRun = true;
	CRuntimeException* pREHadVirus = NULL;*/
