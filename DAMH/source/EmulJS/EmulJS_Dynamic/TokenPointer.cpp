...
// CTokenPointerOld::CTokenPointerOld(CTokenPointer *pTokenForabc)
// {
// 	m_currChOld = NULL;
// 	m_nextChOld = NULL;
// 	m_prevChOld = NULL;
...
// m_nTokenStartOld =0;	
// m_nTokenEndOld = 0;	
// m_nTokenLastEndOld = 0;
// m_sTokenStrOld = " ";
// 
// m_szDataOld = ;
// m_nDataStartOld = 0;
// m_nDataEndOld = 0; 
// m_bDataOwnedOld = true;
// m_bHadEnterCharacterOld = true;
// 
// m_nDataPosOld = 0;
// 
// }
...
// 		byTmpChar = m_szData[lastCharIdx];
// 		m_szData[lastCharIdx] = 0;
// 		sNewSubTkData = &m_szData[beginPosition];
// 		m_szData[lastCharIdx] = byTmpChar;
...
void CTokenPointer::GetNextToken() 
{
	...
	m_nTokenId = TK_EOF;
	m_bHadEnterCharacter = false;
	m_sTokenStr.clear();		 // Xóa tên đặc tả của token
