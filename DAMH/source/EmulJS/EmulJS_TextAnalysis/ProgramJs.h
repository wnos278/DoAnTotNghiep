...
struct ProofVar {
	string sName; // tên biến vế trái của biểu thức
	vector<string> sFunc; // danh sách các hàm có tác động đến biến này
};
